...
def check_zumy_static_collision(zumy_pose, zumy_pose_list, zumy_ID_list, infl_robot_radius, lin_buffer_dist):
	...
	for rbt_j in range(len(zumy_BBox_List)):
		...
		if (zumy_BBox.isRectIntersection(zumy_BBox_List[rbt_j])):
			zumy_collision_list.append[zumy_ID_list[rbt_j]]

	return zumy_collision_list
