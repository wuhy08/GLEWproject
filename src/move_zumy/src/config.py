...
finalTurnSpd = .10		# when we are really close in location and orientation, this is how slowly we turn		
zumy_ar_pair = {'zumy1b': 'ar_marker_6', 'zumy5b': 'ar_marker_5', 'zumy7a': 'ar_marker_4'} #define Zumy-AR tag pairs
