...
slowTurnSpd = 0.16		# max turn speed when close to goal (within lookAheadPtDist)
maxTurnSpd = 0.16		# max turn speed when not near goal 
ang_z_ramp_up_spd = 0.1 # max |dw/dt| change allowed
finalTurnSpd = .08		# when we are really close in location and orientation, this is how slowly we turn		
