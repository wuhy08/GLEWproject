...
if("FALSE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/cc/ee106a/fa15/class/ee106a-cn/ros_workspaces/project/src/main)
  set(main_DEVEL_PREFIX /home/cc/ee106a/fa15/class/ee106a-cn/ros_workspaces/project/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/cc/ee106a/fa15/class/ee106a-cn/ros_workspaces/project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-cn <ee106a-cn@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa15/class/ee106a-cn/ros_workspaces/project/install/${idir}'.  Ask the maintainer 'ee106a-cn <ee106a-cn@todo.todo>' to fix it.")
    endif()
